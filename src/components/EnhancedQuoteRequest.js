...
      className="form-section"
    >
      <h2>Step 9: Future & Strategic Vision</h2>
      <div className="form-group">
...
          rows="2"
          required
          placeholder="e.g., '20% staff increase in next 3 years', 'expanding to a new office location'."
...
      </div>
      <div className="form-group">
        <label htmlFor="threeYearVision">3-Year Vision for Document Workflow <span className="required">*</span></label>
        <textarea
          id="threeYearVision"
...
          rows="4"
          required
          placeholder="e.g., 'Transitioning to a paperless environment', 'centralizing all printing via a single service'."
...
    const payload = mapFormDataToBackend(formData, auth?.user);
    return (
      <motion.div
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
...
        <p>Please review the information you are about to submit.</p>
        <details>
          <summary>View Full Data Payload</summary>
...
  const steps = [
    { id: 1, name: 'Company Info', component: renderStep1, progress: 10 },
    { id: 2, name: 'Needs & Urgency', component: renderStep2, progress: 20 },
    { id: 3, name: 'Usage & Volume', component: renderStep3, progress: 30 },
    { id: 4, name: 'Technical', component: renderStep4, progress: 40 },
    { id: 5, name: 'Current Equipment', component: renderStep5, progress: 50 },
    { id: 6, name: 'New Equipment', component: renderStep6, progress: 60 },
    { id: 7, name: 'Service', component: renderStep7, progress: 70 },
    { id: 8, name: 'Budget & Decision', component: renderStep8, progress: 80 },
    { id: 9, name: 'Future Vision', component: renderStep9, progress: 90 },
    { id: 10, name: 'Review', component: renderReviewStep, progress: 100 },
  ];
...
        <div className="progress" style={{ width: `${currentStepData.progress}%` }}></div>
