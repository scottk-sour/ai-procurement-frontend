import React, { lazy, Suspense, useEffect } from "react";
     ...
     import { HelmetProvider } from "react-helmet-async"; // Added for Helmet context
     ...
     const errorStyle = {
       ...
       minHeight: "100vh",
       display: "flex",
       alignItems: "centre", // British English spelling
       justifyContent: "centre", // British English spelling
     };
             ...
             <div style={errorStyle}>
               ...
               <pre
                 style={{
                   ...
                   margin: '10px',
                   padding: '10px',
                   backgroundColour: '#eee', // British English spelling
                   maxHeight: '60vh',
                   overflowY: 'auto',
                 }}
               >
     ...
     const LoadingSpinner = () => (
       <div
         ...
         aria-live="polite"
         style={{
           backgroundColour: "lightgreen", // British English spelling
           minHeight: "100vh",
           colour: "black", // British English spelling
           display: "flex",
     ...
     const router = createBrowserRouter(
       ...
       {
         future: {
           v7_startTransition: true, // Suppress v7_startTransition warning
           v7_relativeSplatPath: true, // Suppress v7_relativeSplatPath warning
         },
       }
     );
