      ...
      <div className="landing-page">
        {Helmet ? (
          <Helmet>
            ...
            <meta
              name="description"
              content="TendorAI automates procurement, accelerates vendor quote comparisons, and provides AI insights for smarter, faster tendering decisions."
            />
          </Helmet>
        ) : (
          console.log('Oops, Helmet is missing!')
        )}
        ...
        >
          ...
          <div className="hero-content">
            <h1 className="hero-title">Revolutionise Your Procurement with AI</h1>
            <p className="hero-subtitle">Free & Instant Access</p>
            <p className="hero-description">
              Connect with top vendors, receive tailored quotes in minutes, and transform your business.
            </p>
              ...
              {[
                {
                  ...
                  quote: "An essential platform that connects us to reliable vendors and optimises our procurement process.",
                  logo: "waleswest.png",
                },
                {
                  name: "MonhingeMotors",
